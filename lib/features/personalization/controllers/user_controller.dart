...
class UserController extends GetxController {
  ...
  uploadUserProfilePicture() async {
    try {
      // When User change the image this function is called and its open the user gallery
      ...
      if (image != null) {
        ...
        // It is going to be refresh the user wherever this user is use, refresh the user and show updated profile picture to us
        user.refresh();
